        ...
        <div className="card-header">
          <div className="flex items-center justify-between w-full">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-primary/10 hover:bg-primary/20 text-primary rounded-lg border border-primary/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium"
            ...
            {currentTeam && (
              <div className="bg-bg rounded-lg border border-border p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-1">Gameweek {currentTeam.gameweek}</h3>
                  ...
                  <div className="flex gap-4 mt-2 sm:mt-0">
                    <div className="text-right">
                      <div className="text-xs text-content-muted">Predicted Points</div>
                      <div className="text-lg font-mono font-semibold text-primary">
                        {(currentTeam.squad.predicted_points ?? 0).toFixed(1)}
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-xs text-content-muted">Total Cost</div>
                      <div className="text-lg font-mono">
                        £{currentTeam.squad.total_cost}m
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-xs text-content-muted">Formation</div>
                      <div className="text-lg font-mono">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h4 className="text-sm text-content-muted mb-3 uppercase font-semibold">
                  ...
                  {/* Bench */}
                  <div>
                    <h4 className="text-sm text-content-muted mb-3 uppercase font-semibold">Bench</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                      {[...currentTeam.squad.bench].sort((a, b) => {
                        ...
                        <div key={player.id} className="p-3 bg-bg rounded-lg border border-border opacity-75">
                          ...
                          <div className="text-xs text-content-muted">{player.team} • £{player.price}m</div>
                        </div>
                      ))}
                    </div>
                        ...
                        return (
                          <>
                            <div className="flex items-center gap-2 text-sm mb-2">
                              <span className="text-content-muted">Captain:</span>
                              <span className="font-semibold text-primary">{currentTeam.squad.captain.name}</span>
                            ...
                            <div className="flex items-center gap-2 text-sm">
                              <span className="text-content-muted">Vice-Captain:</span>
